            ...
            <div class="flex-1">
                <div class="flex h-full">
                    <div class="flex-1">
                        ...
                        <div class="space-y-4 pt-12 pb-16">
                                    ...
                                    <div class="flex flex-col h-full space-y-2 p-2">
                                        ...
                                        <div class="flex-none">
                                            <div class="flex flex-col space-y-2">
                                                ...
                                                <button class="py-3 px-5 bg-blue hover:bg-blue-600 focus:outline-none focus:shadow-outline rounded-md shadow-lg" type="button" wire:click="sendRequest">
